...
class Pickfu < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/pickfu/pickfu-cli/releases/download/v0.6.0/pickfu-v0.6.0-422f019-darwin-arm64.tar.gz"
      sha256 "b852236b0e824aee5447a3497bfb888b9164898d7b4470e7522e8fc67444183e"
    else
      url "https://github.com/pickfu/pickfu-cli/releases/download/v0.6.0/pickfu-v0.6.0-422f019-darwin-x64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/pickfu/pickfu-cli/releases/download/v0.6.0/pickfu-v0.6.0-422f019-linux-arm64.tar.gz"
      sha256 "a71dc57de194bd6d7c2292642ccad28e5074231fd6f2a46cf316c90617416cdb"
    else
      url "https://github.com/pickfu/pickfu-cli/releases/download/v0.6.0/pickfu-v0.6.0-422f019-linux-x64.tar.gz"
